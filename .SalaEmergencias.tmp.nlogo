...
@#$#@#$#@
# ESTUDIANTES
-- Jefferson Álvarez - B60380
-- Walter Bonilla    - B61144
-- Sergio Tijerino   - B67130
...
Este agente representa a los pacientes que arriban a una sala de emergencia en busca de atención.

#### Atributos
-- Tiempo de llegada: Indica el momento en el que llegó el paciente a la sala de emergencia (es el estado inicial)

-- Tiempo de vida: Indica cuanto hasta que minuto se mantiene el paciente con vida (en caso de que no lo atiendan)

-- Categoría: Indica que tan grave es su condición, las categoría son: leve (1), grave (1) y muy grave (3)

#### Estados
Estados transitorios:

-- Llegada: el paciente acaba de llegar a la sala de espera.

-- Espera de enfermera: el paciente está esperando a ser atendido por una enfermera para verificar su categoría.

-- Verificando condición: el paciente está siendo atendido por una enfermera.

-- Espera de atención: el paciente ya cuenta con una categoría y espera a ser atendido.

-- En quirófano: el paciente está siendo atendido por uno o varios doctores.

-- Esperando cama: la atención al paciente ha finalizado y espera a estar en reposo.

-- Listo para salir: el paciente ya ha sido atenido, está en reposo y listo para salir.

Estados finales:

-- Muerte; el paciente murio antes de ser atendido.

-- Atención correcta: el paciente fue atendido correctamente.

### Enfermera
Este agente representa a las enfermeras de una sala de emergencias. Se encargan de evaluar al paciente que se encuentra en el estado de “espera de enfermera” yasignarle  un  estado  de  su  condición  de  salud, a esa condición le se le llama categoría.

#### Atributos
-- Estado: indica el estado de la enfermera

#### Estados
-- Ocupado: la enfermera se encuentra ocupada atenciendo a un paciente.

-- Desocupado: la enfermera se encuentra libre para recibir a los pacientes.

### Doctor
Este agente representa a los doctores de un hospital. Son los encargados de dar atención a los pacientes que se encuentren en el estado de "espera de atención".

#### Atributos
-- Estado: indica el estado del doctor.

#### Estados
-- Ocupado: el doctor se encuentra ocupado atenciendo a un paciente.

-- Desocupado: el doctor se encuentra libre para atender a los pacientes.


# CÓMO USARLO

## Parametros
-- Cantidad de doctores: Establece la cantidad de doctores disponibles que van a prestar atención a los pacientes.

-- Cantidad de enfermeras: Establece la cantidad de enfermeras disponibles para determinar las categorías de los pacientes atención a los pacientes.

-- Cantidad de salas: Establece la cantidad de salas disponibles para atender a los pacientes graves y muy graves.

-- Cantidad de camas: Establece la cantidad de camas disponibles para que los pacientes graves y muy graves tomen reposo después de su atención.

-- Promedio tiempo de atención de pacientes leves: Establece el tiempo promedio que se necesita para dar completa atención a los pacientes leves.

-- Promedio tiempo de atención de pacientes graves: Establece el tiempo promedio que se necesita para dar completa atención a los pacientes graves.

-- Promedio tiempo de atención de pacientes muy graves: Establece el tiempo promedio que se necesita para dar completa atención a los pacientes muy graves.

-- Pacientes leves (\%): Establece cuál es la probabilidad de que la enfermera detecte que la categoría de un paciente sea leve. Es lo mismo decir que es la probabilidad de que la próxima llegada sea la de un paciente leve.

-- Pacientes graves (\%): Establece cuál es la probabilidad de que la enfermera detecte que la categoría de un paciente sea grave. Es lo mismo decir que es la probabilidad de que la próxima llegada sea la de un paciente grave.

-- Pacientes muy graves (\%): Establece cuál es la probabilidad de que la enfermera detecte que la categoría de un paciente sea muy grave. Es lo mismo decir que es la probabilidad de que la próxima llegada sea la de un paciente muy grave.

-- Promedio tiempo entre arribos: Establece cual es el tiempo promedio entre las llegadas de los pacientes.

## Salidas
-- Camas desocupadas: Indica el número de camas disponibles para que reposen los pacientes que han sido atendidos.

-- Llegadas: Indica la cantidad total de pacientes que han llegado a la sala de emergencias.

-- Pacientes leves: Indica la cantidad de pacientes leves que se encuentran en la sala de emergencias.

-- Pacientes graves: Indica la cantidad de pacientes graves que se encuentran en la sala de emergencias.

-- Pacientes muy graves: Indica la cantidad de pacientes muy graves que se encuentran en la sala de emergencias.

-- Atenciones correctas: Indica el número de pacientes que han salido de la sala de emergencias atendidos correctamente.

-- Muertes: Indica el número de muertes de pacientes que han ocurrido durante su estadía en la sala de emergencias.

# COSAS AL AVISO
-- Se puede ver que el tiempo entre arribos es un factor importante si no se cuenta con una gran cantidad de camas y salas.

-- Otra opcion es ver que una cantidad baja de enfermeras no es un factor muy determinante.

# COSAS PARA INTENTAR
-- Se puede intentar bajar el tiempo entre arribos y mover los parámetros del sistema para ver cual es la mejor configuración con la cual ocurra la menor cantidad de muertes

-- En otro caso se pueden cambiar los porcentajes de gravedad de los pacientes para ver cual es el comportamiento del sistema según las condiciones de los pacientes.

# AMPLIANDO EL MODELO

## Posibles mejoras:
-- Como primer mejora se pueden dividir los doctores en especialidades para hacer mas real la simulación, para ello también se deberían dividir los pacientes en diversos tipos de enfermedades.

-- Se puede mejorar también el hecho de que los pacientes muy graves (rojos) siempre llegan en ambulancia pues la condición así lo requiere, entonces estos no deberían saber su condición hasta que las enfermeras los revisen.

# MODELOS RELACIONADOS

(modelos en la biblioteca de modelos de NetLogo y en otros lugares que tengan interés relacionado)
@#$#@#$#@
default
true
0
